...
\begin{frame}{Стабилизация ландшафта потерь и достаточный размер выборки}
    ...
    \begin{block}{Требуется}
        Построить критерий стабилизации поверхности функции потерь, согласованный с эмпирически наблюдаемой \alert{\textbf{анизотропией}} спектра матрицы Гессе, и получить на его основе количественные оценки достаточного размера обучающей выборки.
    \end{block}
...
\begin{frame}{Вычислительный эксперимент 2: скорость убывания критериев и подгонка степенного закона}
    ...
    Численные показатели $\alpha$ согласуются с теоретическими: $\alpha\approx 2$ для $\Delta_2$ и $\Delta_2^{(D)}$.
\end{frame}

\begin{frame}{Выносится на защиту}
    \begin{enumerate}
        \item Предложен унифицированный критерий $p$-сходимости $\Delta_p$ с функцией предпочтения точек в пространстве параметров, охватывающий одноточечную и интегральные постановки стабилизации ландшафта.
        \item Введен среднеквадратичный критерий $\Delta_2^{(D)}$ в подпространстве ведущих собственных векторов Гессе с замкнутым спектральным выражением и экстремальностью подпространства главных направлений.
        \item Доказаны теоремы об экстремальности подпространства ведущих собственных векторов матрицы Гессе и сходимости соответствующего критерия.
        \item Разработаны численные методы оценки критерия $\Delta_2^{(D)}$ на основе произведений матрицы Гессе на вектор и моментов гауссовских квадратичных форм.
        \item Эмпирически исследован достаточный размер выборки на основе оценок скорости убывания введенного критерия.
    \end{enumerate}
\end{frame}
...
\begin{frame}{Список работ автора по теме ВКР}
    ...
    \begin{enumerate}
        ...
        \item \textit{\textbf{Kiselev N.}, Grabovoy A.} Sample Size Determination: Posterior Distributions Proximity~//\\\textit{Computational Management Science}, 2025.
    ...
    \begin{enumerate}
        ...
        \item Достаточный размер выборки и его связь со сходимостью поверхности функции потерь~//\\\textit{22-я Всероссийская конференция с международным участием <<ММРО>>}, 2025.
