...
\begin{table}[ht]
    ...
    \begin{tabular}{@{}p{3.8cm} p{3.4cm} p{2.2cm} p{4.0cm}@{}}
        ...
        Квадратичная МК~$\widehat \Delta_{2,\mathrm{quad}}^{(D)}$ & квадр. аппроксимация & $a_k, \mathbf c_k, \mathbf B_k$ & $\mathcal O(SD^2)$ \\[0.3em]
        Замкнутая форма~$\widehat \Delta_{2,\mathrm{GM}}^{(D)}$ & квадр. аппроксимация & $a_k, \mathbf c_k, \mathbf B_k$ & $\mathcal O(D^2)$ \\
        \bottomrule
    \end{tabular}
\end{table}
\end{frame}
