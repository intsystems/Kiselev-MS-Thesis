...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\linewidth]{criterion_abs.pdf}
    \caption{Иллюстрация абсолютного одноточечного критерия сходимости $\Delta_{1}(k)$ в фиксированной точке окрестности минимума}
    \label{fig:criterion-abs}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\linewidth]{criterion_squared.pdf}
    \caption{Иллюстрация среднеквадратичного критерия сходимости $\Delta_{2}(k)$ с гауссовским распределением точек в полном пространстве параметров}
    \label{fig:criterion-squared}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\linewidth]{criterion_squared_subspace.pdf}
    \caption{Иллюстрация среднеквадратичного критерия сходимости в подпространстве наибольшей кривизны $\Delta_{2}^{(D)}(k)$}
    \label{fig:criterion-squared-subspace}
\end{figure}
...
\begin{table}[ht]
    ...
    \begin{tabular}{@{}p{3.5cm} p{3.3cm} p{2.1cm} p{7.2cm}@{}}
        \toprule
...
\textbf{Выводы по главе.} В данной главе на основе общего критерия $p$-сходимости~\eqref{eq:general-p-criterion}, введенного в главе~\ref{sec2}, изучены три частных случая, допускающих явные теоретические оценки скорости убывания при увеличении объема обучающей выборки.
